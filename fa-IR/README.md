...
<span>من سوالات جاوا اسکریپت چند گزینه‌ای را در [اینستاگرام](https://www.instagram.com/theavocoder) **استوری**
پست کردم, همچنین در اینجا قرار دادم! آخرین بروزرسانی در: <a href=#20200612><b>۲۲ خرداد ۱۴۰۰</b></a>

از مبتدی تا پیشرفته: بررسی کنید چقدر جاوا اسکریپت می‌دانید, یک مقدار دانش خود را تازه کنید, یا خود را برای یک مصاحبه جاوا اسکریپت آماده کنید! :muscle: :rocket: من این ریپو را معمولا با سوالات تازه بروزرسانی می‌کنم. من جواب‌ها را با در **بخش جمع شونده** زیر سوالات قرار می‌دهم, با یک کلیک ساده بر روی آن‌ها باز می‌شوند. این فقط برای جالب بودن است, موفق باشید! :heart:</span>

با خیال راحت با من در ارتباط باشید! 😊 <br />
<a href="https://www.instagram.com/theavocoder">اینستاگرام</a> || <a href="https://www.twitter.com/lydiahallie">تویتتر</a> || <a href="https://www.linkedin.com/in/lydia-hallie">لینکدین</a> || <a href="https://www.lydiahallie.dev">بلاگ</a>
</div>

| با خیال راحت آن‌ها را در پروژه‌های خود استفاده کنید! 😃  من _واقعا_ خوشحال می‌شوم به این ریپو ارجاع بدهید, من سوالات و توضیحات رو ایجاد کرده‌ام و جامعه کمک بسیار زیادی به من در نگهداری و توسعه کرده است! 💪🏼 ممنونم و خوش باشید!   |
|---|

---

<details><summary><b> مشاهده ۱۹ ترجمه موجود 🇸🇦🇪🇬🇧🇦🇩🇪🇪🇸🇫🇷🇮🇩🇯🇵🇰🇷🇳🇱🇧🇷🇷🇺🇹🇭🇹🇷🇺🇦🇻🇳🇨🇳🇹🇼🇮🇷</b></summary>
<p>
